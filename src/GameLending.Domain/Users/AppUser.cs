...
namespace GameLending.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update GameLendingDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update GameLendingEfCoreEntityExtensionMappings to extend the IdentityUser entity
