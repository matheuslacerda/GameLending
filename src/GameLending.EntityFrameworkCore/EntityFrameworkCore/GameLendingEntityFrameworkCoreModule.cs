...
{
    [DependsOn(
        typeof(GameLendingDomainModule),
    ...
    public class GameLendingEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also GameLendingMigrationsDbContextFactory for EF Core tooling. */
